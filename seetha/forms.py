...
class CarLoanForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            # 'gst_certificate': forms.TextInput(attrs={'id': 'id_gst_certificate'}),
            # 'gst_certificate': forms.CheckboxInput(),
    ...
    def clean_aadhar_pincode(self):
        ...
        if aadhar_pincode:
            ...
            if not re.match(r'^\d{6}$', aadhar_pincode_str):
                raise forms.ValidationError("Aadhar pincode must be a 6-digit number.")
